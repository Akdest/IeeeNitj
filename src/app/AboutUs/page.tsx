...
export default function About() {
  return (
    ...
    <div className="w-full flex justify-center bg-white min-h-screen py-10">
      <div className="w-[90%] max-w-7xl flex flex-col gap-20">
        {/* Header */}
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-10">
          ...
          {/* IEEE Image */}
          <div
            className="w-full sm:w-[400px] md:w-[500px] h-[250px] sm:h-[300px] lg:h-[350px] rounded-3xl shadow-md"
            style={{
              backgroundImage: "url('/ieee.png')",
